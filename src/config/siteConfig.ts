export const siteConfig = {
  companyName: import.meta.env.VITE_COMPANY_NAME || 'TanovaX',
  tagline: import.meta.env.VITE_TAGLINE || 'Web • Apps • Business Solutions',
  headline: import.meta.env.VITE_ALT_HEADLINE || 'Digital Solutions Built Around Your Business',
  ...
  social: {
    linkedin: 'https://linkedin.com/company/tanovax',
    instagram: 'https://instagram.com/tanovax',
    github: 'https://github.com/tanovax',
  },
  cta: {
    primary: 'Start a Project',
    secondary: 'View Our Work',
    contact: 'Send Project Enquiry',
  }
};
